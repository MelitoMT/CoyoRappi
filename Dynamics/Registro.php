        ...
        if(isset($_POST['tipo']) && $_POST['tipo']!='' ){
            if(isset($_POST['Siguiente'])){
                ...
                if($contraseña==$contraseña2){
                    ...
                    $nombre=strip_tags(mysqli_real_escape_string($conexion,$_POST['Nombre']));
                    $apaterno=strip_tags(mysqli_real_escape_string($conexion,$_POST['Apaterno']));
                    $amaterno=strip_tags(mysqli_real_escape_string($conexion,$_POST['Amaterno']));
                    $usuario=strip_tags(mysqli_real_escape_string($conexion,$_POST['Usuario']));
                    $tipo=$_POST['tipo'];
                    $atributo='';
                    $dato='';
